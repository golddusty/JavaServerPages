...
Readme and License for the JavaServer Pages, 2nd Edition example package
------------------------------------------------------------------------

This package contains all JSP application examples and the source
code for all Java classes described in the book JavaServer Pages, 2nd
...
Archive structure as an open file system structure). For the Tomcat 4
...
* The JSTL Reference Implementation, covered by the license in
  ...
  jaxen-full.jar, jaxp-api.jar, jdbc2_0-stdext.jar, jstl.jar,
  sax.jar, saxpath.jar, standard.jar, xalan.jar, xercesImpl.jar
