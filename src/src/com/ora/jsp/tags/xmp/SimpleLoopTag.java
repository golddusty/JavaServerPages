 ...
 * <p>
 * Note! This action is just intended as an example. I recommend that
 * you use the JSTL &lt;c:forEach&gt; action instead.
 *
 * @author Hans Bergsten, Gefion software <hans@gefionsoftware.com>
 * @version 1.0
 */
public class SimpleLoopTag extends BodyTagSupport {
    // Property variables
    private String name;
